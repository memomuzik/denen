...
from TS.utils.database import get_loop
from TS.utils.decorators import AdminRightsCheck
from TS.utils.inline import close_markup, stream_markup
...
@app.on_message(
    filters.command(["skip", "atla", "next", "cnext"]) & filters.group & ~BANNED_USERS
)
@AdminRightsCheck
